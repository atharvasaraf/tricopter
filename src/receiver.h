...
#include "variables.h"
//Namespaces are implemented in a jugaad manner using r_blabla

volatile int r_previous_time=0;//state.r_input_signal[6]={0};
...
{
  //enableInterrupt(arduinoInterruptedPin , fallHandler, FALLING);
...
void receiverSetup()
{
//Copy the comments from NIkhils repo version of code
